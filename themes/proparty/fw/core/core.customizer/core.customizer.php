<?php
/**
 * AxiomThemes Framework: Customize css
 *
 * @package	axiom
 * @since	axiom 1.0
 */
...
// Theme init
if (!function_exists('axiom_core_customizer_theme_setup')) {
	add_action( 'axiom_action_before_init_theme', 'axiom_core_customizer_theme_setup' );
	function axiom_core_customizer_theme_setup() {

		// Add core customization in the custom css
		add_filter( 'axiom_filter_add_styles_inline', 'axiom_core_customizer_add_custom_styles' );
...
if (!function_exists('axiom_core_customizer_add_custom_styles')) {
	//add_filter( 'axiom_filter_add_styles_inline', 'axiom_core_customizer_add_custom_styles' );
