 ...
 */
add_action( 'widgets_init', 'axiom_widget_flickr_load' );

/**
 * Register our widget.
 */
function axiom_widget_flickr_load() {
	register_widget( 'axiom_widget_flickr' );
}

/**
 * flickr Widget class.
 */
class axiom_widget_flickr extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_flickr', 'description' => __('Last flickr photos.', 'axiom') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'axiom_widget_flickr' );

		/* Create the widget. */
		parent::__construct( 'axiom_widget_flickr', __('AxiomThemes - Flickr photos', 'axiom'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'count' => 6, 'description' => __('Last flickr photos', 'axiom') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_username' )); ?>"><?php _e('Flickr ID (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):', 'axiom'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_count' )); ?>"><?php _e('Number of photos:', 'axiom'); ?></label>
