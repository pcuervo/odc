 ...
 */
add_action( 'widgets_init', 'axiom_widget_recent_posts_load' );

/**
 * Register our widget.
 */
function axiom_widget_recent_posts_load() {
	register_widget('axiom_widget_recent_posts');
}

/**
 * Recent posts Widget class.
 */
class axiom_widget_recent_posts extends WP_Widget {
