 ...
 */
add_action( 'widgets_init', 'axiom_widget_recent_reviews_load' );

/**
 * Register our widget.
 */
function axiom_widget_recent_reviews_load() {
	register_widget('axiom_widget_recent_reviews');
}

/**
 * recent_reviews Widget class.
 */
class axiom_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'axiom'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'axiom_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'axiom_widget_recent_reviews', __('AxiomThemes - Recent reviews', 'axiom'), $widget_ops, $control_ops );
	...
	function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_2"><?php _e('As stars', 'axiom'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php _e('As icon', 'axiom'); ?></label>
