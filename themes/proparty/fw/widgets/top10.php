 ...
 */
add_action( 'widgets_init', 'axiom_widget_top10_load' );

/**
 * Register our widget.
 */
function axiom_widget_top10_load() {
	register_widget('axiom_widget_top10');
}

/**
 * Top10 Widget class.
 */
class axiom_widget_top10 extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		if (count($tabs) > 0) {
			...
			if (count($tabs) > 1) axiom_enqueue_script('jquery-ui-tabs', false, array('jquery','jquery-ui-core'), null, true);
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_author')); ?>"><?php _e('Author rating tab title:', 'axiom'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_users')); ?>"><?php _e('Users rating tab title:', 'axiom'); ?></label>
