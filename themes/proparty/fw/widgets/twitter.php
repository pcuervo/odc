 ...
 */
add_action( 'widgets_init', 'axiom_widget_twitter_load' );

/**
 * Register our widget.
 * 'Twitter_Widget' is the widget class used below.
 */
function axiom_widget_twitter_load() {
	register_widget( 'axiom_widget_twitter' );
}

/**
 * Twitter Widget class.
 */
class axiom_widget_twitter extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_twitter', 'description' => __('Last Twitter Updates. Version for new Twitter API 1.1', 'axiom') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'axiom_widget_twitter' );

		/* Create the widget. */
		parent::__construct( 'axiom_widget_twitter', __('AxiomThemes - Twitter', 'axiom'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_count' )); ?>"><?php _e('Tweets count:', 'axiom'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_username' )); ?>"><?php _e('Twitter Username:', 'axiom'); ?><br />(<?php _e('leave empty if you paste widget code', 'axiom'); ?>)</label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_consumer_key' )); ?>"><?php _e('Twitter Consumer Key:', 'axiom'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_consumer_secret' )); ?>"><?php _e('Twitter Consumer Secret:', 'axiom'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_token_key' )); ?>"><?php _e('Twitter Token Key:', 'axiom'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_token_secret' )); ?>"><?php _e('Twitter Token Secret:', 'axiom'); ?></label>
