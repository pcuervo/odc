...
if (axiom_get_custom_option("show_post_author") == 'yes') {
	...
	if ($post_data['post_type']=='post') {
		...
		if ($show_post_author_socials) $post_author_socials = axiom_show_user_socials(array('author_id'=>$post_data['post_author_id'], 'style'=>'bg', 'size'=>'small', 'style'=>'icons', 'echo' => false));
	}
